...
<p> ATTENTION ! Vous souhaitez surprimé la recette <?= $recette['title'] ?> La sentence sera irrémédiable !!!!</p>



</div>
<a type="button" class="btn btn-danger" href="delete_user.php?id=<?php echo $id_user;?>&confirm=ok">Cliquez ici si vous souhaitez vraiment supprimer l'recette</a>
